...
public class DependencyLoaderListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        AccountsController accountsController = new AccountsController(depositWithdrawService,accountOpeningService, accountTransactionService, accountTypeDAO, balanceDAO, mapper);
